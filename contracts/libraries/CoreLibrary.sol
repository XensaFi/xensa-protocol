...
library CoreLibrary {
    ...
    struct ReserveData {
        ...
        **/
        ...
        uint256 unit;
        /**
        * @dev address of the xToken representing the asset
        **/
    ...
    **/
    function init(
        ...
        require(_self.xTokenAddress == address(0), "Reserve has already been initialized");
        ...
        _self.xTokenAddress = _xTokenAddress;
        _self.decimals = _decimals;
        _self.unit = 10 ** _decimals;
