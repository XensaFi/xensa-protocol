...
/**
* @title XensaDataProvider contract
* @author Xensa
...
**/
contract XensaDataProvider is VersionedInitializable {
    ...
    **/
    ...
    function initialize(XensaAddressesProvider _addressesProvider) public initializer {
        ...
        core = XensaCore(_addressesProvider.getXensaCore());
    }
    ...
    **/
    ...
    function getHealthFactorAfterDecrease(address _reserve, address _user, uint256 _amount, bool _isDecrease)
        external
        view
        returns (uint256)
    {
        ...
        if(_isDecrease){
            ...
            vars.collateralBalancefterDecrease = vars.collateralBalanceETH.add(
                vars.amountToDecreaseETH
            );
            vars.liquidationThresholdAfterDecrease = vars
            .collateralBalanceETH
            .mul(vars.currentLiquidationThreshold)
            .add(vars.amountToDecreaseETH.mul(vars.reserveLiquidationThreshold))
            .div(vars.collateralBalancefterDecrease);
        }        
   ...
   **/
    ...
    **/
    ...
    /**
    * @dev accessory functions to fetch data from the xensaCore
    **/
        ...
        )
    {
        ...
        xTokenAddress = core.getReserveXTokenAddress(_reserve);
    ...
    {
        currentXTokenBalance = XToken(core.getReserveXTokenAddress(_reserve)).balanceOf(_user);
