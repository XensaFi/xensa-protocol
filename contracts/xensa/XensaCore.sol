...
/**
* @title XensaPoolCore contract
* @notice Holds the state of the xensa and all the funds deposited
...
* The check that an action can be performed is a duty of the overlying xensa contract.
**/

contract XensaCore is VersionedInitializable {
    ...
    **/
    ...
    address public xensaAddress;

    XensaAddressesProvider public addressesProvider;

    /**
    * @dev only xensa can use functions affected by this modifier
    **/
    modifier onlyXensa {
        require(xensaAddress == msg.sender, "The caller must be a xensa contract");
        _;
    }
    ...
    * @dev only xensa can use functions affected by this modifier
    **/
    modifier onlyXensaStaff {
        require(xensaAddress == msg.sender ||  
        addressesProvider.getXensaLiquidationManager() == msg.sender, "The caller must be a xensa contract");
        _;
    }

    /**
    * @dev only xensa configurator can use functions affected by this modifier
    **/
    modifier onlyXensaConfigurator {
        require(
            addressesProvider.getXensaConfigurator() == msg.sender,
            "The caller must be a xensa configurator contract"
        );
        _;
    }
    ...
    **/
    ...
    ) external onlyXensa returns (uint256, uint256) {
    ...
    **/
    ...
    ) external onlyXensa returns (CoreLibrary.InterestRateMode, uint256) {
    ...
    * @param _balanceIncrease the accrued interest on the borrowed amount
    * @param _liquidatorReceivesXToken true if the liquidator will receive xTokens, false otherwise
    **/
    function updateStateOnLiquidation(
        ...
        uint256 _balanceIncrease,
        bool _liquidatorReceivesXToken
    ) external onlyXensaStaff {
    ...
    **/
    function() external payable {
        ...
        require(msg.sender.isContract(), "Only contracts can send ether to the xensa core");
    ...
    **/
    function liquidateFee(
        ...
        uint256 _amount,
        address _destination
    ) external payable onlyXensaStaff {
        address payable feeAddress = address(uint160(_destination)); //cast the address to payable
        require(
            msg.value == 0,
    ...
    * needed to calculate the global account data in the XensaDataProvider
    ...
    **/
    ...
    /**
    * @dev gets the underlying asset balance of a user based on the corresponding xToken balance.
    * @param _reserve the reserve address
    ...
    **/
    ...
    function getUserUnderlyingAssetBalance(address _reserve, address _user)
        ...
        returns (uint256)
    {
        XToken xToken = XToken(reserves[_reserve].xTokenAddress);
        return xToken.balanceOf(_user);
    ...
    **/
    ...
    function getReserveUnit(address _reserve) public view returns (uint256) {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
        return reserve.unit;
    }

    /**
    * @dev gets the xToken contract address for the reserve
    * @param _reserve the reserve address
    * @return the address of the xToken contract
    **/

    function getReserveXTokenAddress(address _reserve) public view returns (address) {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
        return reserve.xTokenAddress;
    }
    ...
    **/
    ...
    function getReserveCurrentStableBorrowRate(address _reserve) public view returns (uint256) {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
        IInterestRateOracle oracle = IInterestRateOracle(addressesProvider.getInterestRateOracle());
    ...
    * It's used in the XensaDataProvider specifically to save gas, and avoid
    ...
    **/
    ...
    /**
    * @dev updates the xensa core configuration
    **/
    function refreshConfiguration() external onlyXensaConfigurator {
        refreshConfigInternal();
    }
    ...
    * @param _reserve the address of the reserve
    * @param _xTokenAddress the address of the overlying xToken contract
    ...
    **/
    ...
    ) external onlyXensaConfigurator {
        reserves[_reserve].init(_xTokenAddress, _decimals, _interestRateStrategyAddress);
    ...
    **/
    function removeLastAddedReserve(address _reserveToRemove)
     external onlyXensaConfigurator {
        ...
        reserves[lastReserve].xTokenAddress = address(0);
    ...
    **/
    ...
    function disableBorrowingOnReserve(address _reserve) external onlyXensaConfigurator {
    ...
    * @param _reserve the address of the reserve
    **/
    function disableReserveAsCollateral(address _reserve) external onlyXensaConfigurator {
    ...
    * @param _reserve the address of the reserve
    **/
    function enableReserveStableBorrowRate(address _reserve) external onlyXensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function disableReserveStableBorrowRate(address _reserve) external onlyXensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function activateReserve(address _reserve) external onlyXensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function deactivateReserve(address _reserve) external onlyXensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function freezeReserve(address _reserve) external onlyXensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    * @param _reserve the address of the reserve
    **/
    function unfreezeReserve(address _reserve) external onlyXensaConfigurator {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
    ...
    **/
    function refreshConfigInternal() internal {
        xensaAddress = addressesProvider.getXensa();
    }
