...
import "../xensa/XensaConfigurator.sol";
import "openzeppelin-solidity/contracts/ownership/Ownable.sol";

contract XensaManager is Ownable, VersionedInitializable {
    using SafeMath for uint256;
    XensaAddressesProvider public addressesProvider;
    XensaConfigurator public conf;
    uint256 public constant CONFIGURATOR_REVISION = 0x3;

    function initAddressProvider(XensaAddressesProvider _addressesProvider) external onlyOwner {
        addressesProvider = _addressesProvider;
        conf = XensaConfigurator(addressesProvider.getXensaConfigurator());
    }
    ...
    function initReserveWithData(
        ...
        address _interestRateStrategyAddress
     	...
     	conf.initReserveWithData(_reserve, _xTokenName,_xTokenSymbol,_underlyingAssetDecimals,_interestRateStrategyAddress);
    }
    ...
    **/
    function refreshXensaCoreConfiguration() external onlyOwner {
        conf.refreshXensaCoreConfiguration();
    }
}
