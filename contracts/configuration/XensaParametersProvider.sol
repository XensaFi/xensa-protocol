...
/**
* @title XensaParametersProvider
* @notice stores the configuration parameters of the Xensa contract
**/

contract XensaParametersProvider is VersionedInitializable {
    ...
    /**
    * @dev initializes the XensaParametersProvider after it's added to the proxy
    * @param _addressesProvider the address of the XensaAddressesProvider
    */
