...
import "../xensa/Xensa.sol";
import "../xensa/XensaDataProvider.sol";
import "../xensa/XensaCore.sol";
import "../libraries/WadRayMath.sol";

/**
 * @title Xensa ERC20 XToken
 *
 * @dev Implementation of the interest bearing token for the DLP protocol.
 */
contract XToken is ERC20, ERC20Detailed {
    ...
    **/
    ...
    XensaAddressesProvider private addressesProvider;
    XensaCore private core;
    Xensa private xensa;
    XensaDataProvider private dataProvider;

    modifier onlyXensa {
        require(
            msg.sender == address(xensa),
            "The caller of this function must be a xensa"
        );
        _;
    }
    ...
    **/
    modifier onlyXensaStaff {
        require(address(xensa) == msg.sender ||  
        addressesProvider.getXensaLiquidationManager() == msg.sender, "The caller must be a xensa staff contract");
        _;
    }
    ...
    constructor(
        XensaAddressesProvider _addressesProvider,
        ...
        xensa = Xensa(addressesProvider.getXensa());
    ...
    **/
    ...
    /**
    * @dev redeems xToken for the underlying asset
    ...
    **/
    ...
    /**
     * @dev mints token in the event of users depositing the underlying asset into the xensa 
     * only xensa can call this function
     * @param _account the address receiving the minted tokens
     * @param _amount the amount of tokens to mint
     */
    function mintOnDeposit(address _account, uint256 _amount) external onlyXensa {
     ...
     * Transfer of the liquidated asset is executed by the xensa contract.
     * only xensa can call this function
     * @param _account the address from which burn the xTokens
     * @param _value the amount to burn
     **/
    function burnOnLiquidation(address _account, uint256 _value) external onlyXensaStaff {
    ...
    /**
     * @dev transfers tokens in the event of a borrow being liquidated, in case the liquidators reclaims the xToken
     *      only xensa can call this function
     * @param _from the address from which transfer the xTokens
     * @param _to the destination address
     * @param _value the amount to transfer
     **/
    function transferOnLiquidation(address _from, address _to, uint256 _value) external onlyXensaStaff {
    ...
    **/
    ...
    /**
    * @dev executes the transfer of xTokens, invoked by both _transfer() and
